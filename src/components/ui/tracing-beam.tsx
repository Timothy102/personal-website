...
export const TracingBeam = ({
  ...
  return (
    <motion.div
      ref={ref}
      className={cn("relative w-full mx-auto h-full min-h-screen", className)}
    >
      <div className="absolute -left-4 md:-left-20 top-3 h-full hidden sm:block">
        <motion.div
          transition={{
            duration: 0.2,
            delay: 0.5,
        ...
        >
          <motion.path
            d={`M 1 0 V ${svgHeight * 0.4} L 39 ${svgHeight * 0.4 + 50} V ${svgHeight}`}
            fill="none"
            stroke="#9091A0"
            strokeOpacity="0.16"
            transition={{
