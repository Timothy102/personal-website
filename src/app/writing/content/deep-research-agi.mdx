...
4. *Intelligence* - In that sense, deep researcher's "intelligence" must be defined by its ability to govern its own conditional probability to convert the constrained research problem into maximizing the possibility to reaching knowledge in answering the true underlying research objective.
